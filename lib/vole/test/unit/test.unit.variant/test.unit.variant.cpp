/* /////////////////////////////////////////////////////////////////////////
 * File:        test.unit.variant.cpp
 *
 * Purpose:     Implementation file for the test.unit.variant project.
 *
...
int main(int argc, char **argv)
{
	...
	if(XTESTS_START_RUNNER("test.unit.variant", verbosity))
	{
...
static void test_1_1()
{
	...
	XTESTS_TEST_INTEGER_EQUAL(1, v.lVal);
}
...
static void test_1_2()
{
	...
	XTESTS_TEST_FLOATINGPOINT_EQUAL(1.2, v.dblVal);
}
...
static void test_1_3()
{
	...
	XTESTS_TEST_ENUM_EQUAL(VT_BSTR, v.vt);
	XTESTS_TEST_WIDE_STRING_EQUAL(L"mbs", v.bstrVal);
}
...
static void test_1_4()
{
	...
	XTESTS_TEST_ENUM_EQUAL(VT_BSTR, v.vt);
	XTESTS_TEST_WIDE_STRING_EQUAL(L"ws", v.bstrVal);
}

static void test_1_5()
{
	vole::variant v = std::string("mbs");
...
{
	vole::variant v = std::wstring(L"ws");
...
static void test_1_7()
{
	...
	vole::variant v = CString("mfcs");

	XTESTS_TEST_ENUM_EQUAL(VT_BSTR, v.vt);
	XTESTS_TEST_WIDE_STRING_EQUAL(L"mfcs", v.bstrVal);
